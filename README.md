...
- Для начала создадим сцену с тремя вариантами: черный куб - 0, белый куб - 1; три варианта: (0 0), (0 1) и (1 1).

![image_26](https://user-images.githubusercontent.com/103308669/204807938-b5a36794-42bc-480f-87b9-046bf1703091.png)

При столкновении кубиков, они окрасятся в цвет результата той или иной операции (черный - 0, белый - 1).
...
https://user-images.githubusercontent.com/103308669/204808306-73005319-50c2-4ca6-89cf-eac497194b8e.mp4

- Запустим программу и посмотрим на результат работы операции AND:

https://user-images.githubusercontent.com/103308669/204808427-b3cb05d6-f870-408d-8507-60fd2f8ee6ee.mp4

- Запустим программу и посмотрим на результат работы операции NAND:

https://user-images.githubusercontent.com/103308669/204808472-be2522bb-dc2a-4371-800d-4eac3111454c.mp4

Цвета кубиков меняются корректно, в соответствии с функциями.
